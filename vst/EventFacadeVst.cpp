...
#include "analysis/FFTBuffer.hpp"
...
namespace nx
{
  ...
  void EventFacadeVst::processVstEvent(Steinberg::Vst::IMessage * rawMessage)
  {
    if ( Steinberg::FIDStringsEqual( rawMessage->getMessageID(), "FFTData" ) )
    {
      // copy the buffer over and then return asap
      m_fftBuffer.write( rawMessage );
    }
  }
  ...
  void EventFacadeVst::consumeAudioData()
  {
