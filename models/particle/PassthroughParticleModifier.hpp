...
namespace nx
{
  ...
  public:
    ...
    explicit PassthroughParticleModifier( const WindowInfo_t& winfo )
      : m_winfo( winfo )
    {}
    ...
    sf::RenderTexture & modifyParticles( const ParticleLayoutData_t& particleLayoutData, std::deque< TimedParticle >& particles ) override
    {
