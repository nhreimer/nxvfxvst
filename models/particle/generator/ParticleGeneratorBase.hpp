...
namespace nx
{
  ...
  //     {
  //       { "type", getType() },
  //       { "colorEasing", SerialHelper::serializeEnum( m_data.colorEasing ) },
  ...
  //   {
  //     m_data.colorEasing = SerialHelper::deserializeEnum< E_TimeEasingType >( j.at( "colorEasing" ) );
  ...
  //     particle->setColorPattern( m_data.colorVertexStartOffset, m_data.colorVertexInterval );
  //
